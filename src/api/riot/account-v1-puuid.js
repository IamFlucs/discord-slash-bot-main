...
/**
 * Search for a summoner by puuid.
 ...
 */
async function searchAccountPuuid(puuid) {
    const debugLog = false;
    const logger = createLogger(debugLog);

    const region = `europe`;
    const riotURL = `.api.riotgames.com/riot/account/v1/accounts/by-puuid/${puuid}`;
            ...
            if (error.response && error.response.data.status) {
                ...
                switch (status_code) {
                    ...
                    case 403:
                        ...
                        break;
                    case 404:
                        errorMessage = 'Summoner not found 1. Please check the game name and tag.';
                        break;
                    case 405:
...
module.exports = { searchAccountPuuid };
